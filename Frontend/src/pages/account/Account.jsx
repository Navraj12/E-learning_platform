  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gray-100 px-6">
      <div className="text-center max-w-2xl">
        <h2 className="text-3xl font-bold text-purple-600 mb-6">My Profile</h2>
        <div className="flex flex-col items-center text-lg text-gray-700 space-y-2">
          <p className="font-semibold">Name - <span className="font-normal">Navraj</span></p>
          <p className="font-semibold">Email - <span className="font-normal">Navraj@gmail.com</span></p>
        </div>
